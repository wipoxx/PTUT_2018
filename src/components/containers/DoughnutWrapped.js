...
const backgroundColorData= ['#ffcccc', '#ff4d4d','#fffa65','#32ff7e','#7efff5','#18dcff','#7d5fff','#4b4b4b','#cd84f1'];
const hoverBackgroundColorData= ['#ffb8b8', '#ff4d4d','#fff200','#3ae374','#67e6dc','#17c0eb','#7158e2','#3d3d3d','#c56cf0'];
